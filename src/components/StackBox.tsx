...
export default function StackBox() {
  ...
  return (
    <div className={`stack-box ${isVisible ? "fadein" : null}`} ref={ref}>
      ...
      <div className="content-box">
        <div className="content-wrapper">
          <p>
            ...
            &nbsp;&nbsp;&nbsp;&nbsp; Minor : [<span className="green-font">"Python"</span>, <span className="green-font">"Spring Boot"</span>, <span className="green-font">"Flutter"</span>, <span className="green-font">"nodejs express"</span>], <br />
