  ...
  return (
    <div className="app">
      <div className='wrap'>
        ...
        <div className={`title-box ${titleAnimation.isVisible ? "fadein" : ""}`} ref={titleAnimation.ref}>
        ...
        <div className="projects-box">
          <h2 className={`title ${projectAnimation.isVisible ? "fadein" : ""}`} ref={projectAnimation.ref}>Projects</h2>
          <div className="project-list">
            <FetchProjects />
          </div>
        </div>
        <div className={`feedback-box ${feedbackAnimation.isVisible ? "fadein" : ""}`} ref={feedbackAnimation.ref}>
